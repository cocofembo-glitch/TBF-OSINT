...
- 🔌 **No-Root Port Scanner:** Fast multi-threaded port scan for common web, database, and SSH services.
- 👤 **Multi-threaded Recon:** Fast username lookup across popular platforms (GitHub, Telegram, Steam, TikTok, DockerHub, etc.).
...
git clone [https://github.com/cocofembo-glitch/TBF-OSINT.git](https://github.com/cocofembo-glitch/TBF-OSINT.git)
